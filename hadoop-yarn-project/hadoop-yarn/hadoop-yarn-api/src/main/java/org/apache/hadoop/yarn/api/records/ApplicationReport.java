...
public abstract class ApplicationReport {
  ...
  public static ApplicationReport newInstance(ApplicationId applicationId,
      ...
      YarnApplicationState state, RMRequestState rmRequestState, String diagnostics, String url,
    ...
    report.setRMRequestState(rmRequestState);
  ...
  /**
   * Get the <code>RMrequestState</code> of the application.
   * @return <code>RMRequestState</code> of the application
   */
  @Public
  @Stable
  public abstract RMRequestState getRMRequestState();

  @Private
  @Unstable
  public abstract void setRMRequestState(RMRequestState rmRequestState);
